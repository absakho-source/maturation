...
class User(db.Model):
    ...
    # must_change_password = db.Column(db.Boolean, default=False)  # Doit changer le mot de passe à la première connexion - TEMPORAIREMENT COMMENTÉ pour permettre la migration
